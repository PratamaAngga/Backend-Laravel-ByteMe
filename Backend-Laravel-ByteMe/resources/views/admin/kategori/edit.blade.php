...
<div class="content-container">
    <div class="mb-5">
        <h2 class="page-header-title mb-2">Edit Category</h2>
        <p class="text-muted mb-0">Modify the existing classification to keep your product catalog organized.</p>
    </div>
            ...
            <div class="mb-5">
                <div class="input-wrapper">
                    ...
                    <p class="instruction-text">
                        ...
                        Ensure the updated name still aligns with the assigned products.
                    </p>
                    @error('nama')
